...
public class helppage {
	...
	public void fuellen() {
		...
		hm.put("!plan", "setzt ein Reminder  fuer ein angegebnes Event (angeben mit Parameter noetig) [!plan eventname Parameter Zeitpunkt bsp:!plan test ?d 11-03-2022 08:40:00]");
	...
	public void speichern(HashMap<String,String> ar) {
		...
		//	fos= new FileOutputStream("/home/luggas/Schreibtisch/Discord_Bot/registrierteSpielert.txt"); -> Linux
			...
			fos=new FileOutputStream(s+"/helppage.txt");
//			System.out.println(s);
	...
	public HashMap<String,String> laden() {
		...
		try {
			...
			String s = Paths.get("").toAbsolutePath().toString();
			fis=new FileInputStream(s+"/helppage.txt");
